...
> 원본 경로: `backend/app/services/matching.py`
> Q4 — ODsay 좌표를 텅텅 DB의 station_id/stop_id로 매칭
...
def match_subway_station(lat: Optional[float], lng: Optional[float]) -> MatchResult:
